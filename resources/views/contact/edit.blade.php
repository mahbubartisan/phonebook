		...
		<div class="flex flex-col items-center pb-10">
			...
			<div class="flex mt-4 space-x-3 md:mt-6">
				...
				<form action="{{ route('update.contact', $contact->id) }}" method="POST" enctype="multipart/form-data">
					...
					<div class="grid gap-6 mb-6 md:grid-cols-2">
						...
						<div>
							...
							<div class="relative">
								...
								<input datepicker type="text" name="birthday" id="birthday" value="{{ $contact->birthday }}"
					...
					<div class="relative">
						<button type="submit"
							class="text-white absolute right-0 bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl hover:shadow-lg focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-9 py-2.5 text-center mb-2">Update</button>
					</div>
				</form>
