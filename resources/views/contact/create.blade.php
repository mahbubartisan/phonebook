...
@section('content')
	<div
		...
		<div class="flex flex-col items-center pb-10">
			...
			<img class="mb-3 mt-7 w-24 h-24 rounded-full shadow-lg" src="{{ asset('upload/user/no-image.png') }}" alt="Bonnie image"
				id="showImage">
			...
			<div class="flex mt-4 space-x-3 md:mt-6">
				...
				<form action="{{ route('store.contact') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="relative">
						<button type="submit"
							class="text-white absolute right-0 bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl hover:shadow-lg focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-9 py-2.5 text-center mb-2">Save</button>
					</div>
				</form>
			</div>
		</div>
