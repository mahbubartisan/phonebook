																...
																<tbody>
																	<tr>
																		<td
																			...
																			valign="top" align="center" bgcolor="#3498db"> <a href="{{ route('reset.password', $token) }}"
																				target="_blank"
							...
							<tr>
								<td class="content-block powered-by"
									...
									Powered by <a href="{{ url('/') }}"
										style="color: #999999; font-size: 12px; text-align: center; text-decoration: none;">PhoneBook</a>.
								</td>
							</tr>
						</table>
					</div>
